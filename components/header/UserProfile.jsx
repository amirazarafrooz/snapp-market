      ...
      <div className="relative " ref={modal}>
        {headerId === "HeaderSc" ? (
          <div
            ...
            href={""}
            className=" flex items-center cursor-pointer laptop:mx-4 h-full"
          >
            <svg
          ...
          <div className="bg-snp-white shadow-md  tablet:ml-12 w-60 mobile:w-60 h-72  rounded-b-lg z-[202]" >
            <div className="flex flex-col justify-center font-iransans p-3 h-[85px] border-b-2 bg-[#FAFAFA] ">
              ...
              <div className="mt-3 text-sm ">
                <span>اعتبار:</span>{" "}
                <span className="bg-orange-400 px-2 py-1 rounded-full text-xs text-snp-white">
                  0 تومان
                </span>
              </div>
            </div>
            <div className=" flex flex-col items-start justify-center w-full ">
              ...
              >
                <svg
                  ...
                  className="ml-2 group-hover:text-snp-primary"
                >
                  <defs>
                    <symbol id="UserIcon" viewBox="0 0 32 32">
                      <path d="M27.313 20.688a15.92 15.92 0 00-6.083-3.817 9.244 9.244 0 003.602-10.367 9.247 9.247 0 00-8.836-6.508 9.246 9.246 0 00-8.832 6.508 9.244 9.244 0 003.602 10.367A16.03 16.03 0 00-.004 32h2.5c0-7.457 6.047-13.5 13.5-13.5 7.457 0 13.5 6.043 13.5 13.5h2.5a15.88 15.88 0 00-4.683-11.313zM15.995 16a6.752 6.752 0 01-6.75-6.75 6.752 6.752 0 016.75-6.75 6.75 6.75 0 110 13.5zm0 0"></path>
                  ...
                  <use fill="" href="#UserIcon" xlinkHref="#UserIcon"></use>
                </svg>
                <span className="group-hover:text-gray-400">حساب کاربری</span>
              </Link>
              ...
              >
                ...
                >
                  ...
                  <use fill="" href="#CoinsIcon" xlinkHref="#CoinsIcon"></use>
                </svg>
              ...
              >
                ...
                >
                  ...
                  <use fill="" href="#LogoutIcon" xlinkHref="#LogoutIcon"></use>
                </svg>
                <span className="group-hover:text-gray-400">خروج</span>
              </Link>
            </div>
          </div>
          </div>
