...
export const UserProfile = ({ headerId , clickHandler, showUserProfile  }) => {
  ...
  return (
    <>
      ...
      {headerId === "HeaderSc" ? (
        <div onClick={clickHandler} href={''} className=" flex items-center cursor-pointer laptop:mx-4 h-full">
          <svg
      ...
      {showUserProfile &&(<div className="bg-snp-white shadow-md  fixed top-14 w-60 h-72 z-50 rounded-b-lg">
        <div className="flex flex-col justify-center font-iransans p-3 h-[85px] border-b-2 bg-[#FAFAFA] ">
          ...
          <div className="mt-3 text-sm "><span>اعتبار:</span> <span className="bg-orange-400 px-2 py-1 rounded-full text-xs text-snp-white">0 تومان</span></div>
        </div>
        <div className=" flex flex-col items-start justify-center w-full ">

          {/* user  */}
<Link href={'/'} className="group hover:bg-[#FAFAFA] flex justify-start p-3 mt-1 items-center text-gray-400 text-[13px]  w-full font-iransans">
<svg
xmlns="http://www.w3.org/2000/svg"
xmlnsXlink="http://www.w3.org/1999/xlink"
width="32"
...
<span className="group-hover:text-gray-400">افزایش اعتباری</span>
</Link>

<Link href={'/products'} className="group hover:bg-[#FAFAFA] flex justify-start p-3 mt-1 items-center text-gray-400 text-[13px]  w-full font-iransans">
<svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      width="23"
...
<span className="group-hover:text-gray-400">لیست‌ سفارش‌ها</span>
</Link>
