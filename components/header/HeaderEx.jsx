...
export const HeaderEx = () => {
  return (
    <div>
    { /* main container */ }
    <div className="w-full h-64 overflow-hidden p-2 tablet:h-56"
      style={{backgroundRepeat:"no-repeat", objectFit: "cover",backgroundSize:"cover", backgroundImage: `url(${headerbanner.src})`,
      }}
    >
      {/*  upper row container  */}
