export const SubCategoryFilter = () => {
  return (
    <>
      <div className="flex-col h-screen px-2 font-iransans text-sm  hidden laptop:hidden ">
        <div className="w-56 px-6 py-4 h-28 mb-4 bg-snp-white rounded-md border-[1px]">
          <div className="flex items-center justify-between mb-4">
            {" "}
            <h3>فیلتر‌های اعمال شده</h3>
          ...
          <div className="flex w-min items-center justify-between p-1  text-[11px] text-snp-secondary bg-blue-100 border-[1px] border-blue-500 rounded-full">
            <span className="whitespace-nowrap ml-1">فیلتر</span>
            <svg
          ...
          <div className="mt-3">
            <ul>
              <li className="flex mt-4">
                ...
                <span className="text-xs accent-snp-gray text-gray-400 font-semibold mr-2">
                  فیلتر
                </span>
              </li>
              <li className="flex mt-4">
                ...
                <span className="text-xs text-gray-400 mr-2 ">فیلتر</span>
              </li>
            </ul>
          </div>
        </div>
