...
export const Footer = () => {
  return (
    <div className="flex flex-col justify-center items-center font-iransans mt-6 mb-20 px-1">
      {/* upper section */}
      <div className="flex flex-col  justify-center tablet:w-192 laptop:w-248 gap-x-4 desktop:w-300 laptop:justify-between ">
        {/* privilege cards */}
        <div className="flex flex-col justify-center items-center leading-7  py-6 tablet:flex-nowrap tablet:justify-center mobile:flex-col mobile:w-144 tablet:flex-row  tablet:w-192  laptop:w-248   desktop:w-300  ">
          <div className="flex  w-full mobile:w-full tablet:w-1/2  desktop:justify-evenly ">
            <div className="flex  flex-col justify-center items-center h-40  mobile:flex-row tablet:flex-col tablet:justify-center tablet:items-center tablet:w-44 tablet:px2 laptop:w-56 ">
              ...
              <div className="flex flex-col justify-center items-center text-center mobile:text-right mobile:items-start tablet:items-center tablet:text-center ">
                <span className="mt-2 mobile:text-sm tablet:text-base">
                  تخفیف بیشتر محصولات
                </span>
                <span className="mt-2 text-sm mobile:text-xs tablet:leading-8 text-gray-500">
            ...
            <div className="flex  flex-col justify-center items-center h-40  mobile:flex-row tablet:flex-col tablet:justify-center tablet:items-center tablet:w-44 tablet:px2 laptop:w-56 ">
              ...
              <div className="flex flex-col justify-center items-center text-center mobile:text-right mobile:items-start tablet:items-center tablet:text-center">
                ...
                <span className="mt-2 mobile:text-xs text-sm  tablet:leading-8 text-gray-500">
          ...
          <div className="flex tablet:w-1/2  desktop:justify-evenly gap-4 ">
            <div className="flex  flex-col justify-center items-center h-40  mobile:flex-row tablet:flex-col tablet:justify-center tablet:items-center tablet:w-44 tablet:px2 laptop:w-56 ">
              ...
              <div className="flex flex-col justify-center items-center text-center mobile:text-right mobile:items-start tablet:items-center tablet:text-center">
                ...
                <span className="mt-2 text-sm mobile:text-xs tablet:leading-8 text-gray-500 laptop:whitespace-nowrap ">
      ...
      {/* lower section */}
      <div className="py-6 tablet:flex laptop:w-248 desktop:w-300 laptop:flex laptop:justify-between">
        <div className="flex  laptop:flex laptop:justify-between  laptop:w-192 desktop:w-248 ">
          ...
          <div className="hidden px-2 mobile:block mobile:flex-auto">
            ...
            <p className="text-sm leading-9 mobile:text-xs mobile:leading-7 mobile:flex-auto mobile:w-44 text-gray-500 laptop:text-sm laptop:leading-7">
              اسنپ مارکت حاصل همکاری دو شرکت بزرگ اسنپ و‌هایپراستار است تا
              کالاهای مورد نیاز کاربران را در اسرع وقت برای آنها ارسال کند.
            </p>
            <span className="text-sm leading-9 text-gray-500">
              <a>هایپر استار</a> | <a>مایلی</a>
            </span>
          </div>
          {/* accesses */}
          ...
          <div className="flex-auto ">
            ...
            <ul className="text-sm leading-9 text-gray-500 mobile:text-xs mobile:leading-7 mobile:flex-auto w-44 laptop:text-sm laptop:leading-7">
              ...
              <li>
                <p>
                  آدرس: خیابان ولیعصر بالاتر از اسفندیار خیابان سعیدی نبش کوچه
                  مهردادپلاک۱ طبقه ۳
                </p>
              </li>
        ...
        <div className="flex justify-around  tablet:w-48 laptop:w-96 tablet:items-start tablet:pt-7 gap-4 mt-4">
