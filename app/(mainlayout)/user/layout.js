        ...
        <div className="w-full flex flex-col font-iransans text-sm h-40 tablet:h-52 laptop:h-64 ">
          ...
          <div className="flex justify-evenly h-full border-t-[1px] laptop:flex-col ">
            <div className="flex justify-center items-center">
              <Link
                href={"/user/profile"}
                className="flex flex-col justify-center p-3 mt-1 items-center text-gray-500 text-[13px]  w-full font-iransans tablet:p-8 laptop:p-1 laptop:flex-row  laptop:justify-between"
              >
            ...
            <div className="flex justify-center items-center ">
              <Link
                href={"/user/orders"}
                className=" flex flex-col bg-snp-light rounded-md justify-center p-3 mt-1 items-center text-snp-secondary text-[13px]  w-full font-iransans tablet:p-8 laptop:p-1 laptop:flex-row laptop:justify-between"
              >
                <div className="flex flex-col justify-center items-center whitespace-nowrap laptop:flex laptop:flex-row ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
